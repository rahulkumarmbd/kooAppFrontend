  ...
  return (
    <AvatarGroup total={4}>
      <Avatar
        ...
        alt="Mujaffar"
        src="/assets/profilepics/muj.jpg"
      />
      <Avatar
        sx={{ height: 25, width: 25 }}
        alt="Rahul"
        src="/assets/profilepics/rahul.jpg"
      />
      <Avatar
        sx={{ height: 25, width: 25 }}
        alt="Rohan"
        src="/assets/profilepics/rohan.jpg"
      />
      <Avatar
        sx={{ height: 25, width: 25 }}
        alt="Sandeep"
        src="/assets/profilepics/sandeep.jpg"
      />
    </AvatarGroup>
  );
}
...
export const TrendTag = (tagname) => {
  return (
    <div className="body-tags">
      ...
      <div className="images">{TotalAvatars()}</div>
    </div>
  );
};
    ...
    <div className="user-main-div">
      <div className="user-avatar">
        ...
        <span className="edit-div">
          <Link to={`/editProfile/${User}`}>Edit Profile</Link>
        </span>
      </div>
      <div className="details">
        ...
        <p>@{user.handle != "null" ? user.handle : "username"}</p>
      </div>
      <div className="other-details">
        <p className="koo-opinion">
          {user.profession != "null" ? user.profession : "Koo Your Opinion!"}
        </p>
